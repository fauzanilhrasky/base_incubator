...
<section id="explanation" class="explanation section dark-background">
    <img src="{{ asset('images/seminar.png') }}" alt="">
...
<section id="call-to-action" class="call-to-action section dark-background">
    <img src="{{ asset('images/calling.png') }}" alt="">
                ...
                <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="{{ asset('images/brands.png') }}" alt="Brand Image 1">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset('images/brands.png') }}" alt="Brand Image 2">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset('images/brands.png') }}" alt="Brand Image 3">
                        </div>
                    </div>
